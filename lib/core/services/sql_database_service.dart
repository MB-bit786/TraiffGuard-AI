...
class SqlDatabaseService {
  ...
  Future<Database> _initDatabase() async {
    ...
    try {
      ...
      final String path = kIsWeb ? 'tariff_guard_v6.db' : p.join(await getDatabasesPath(), 'tariff_guard.db');

      // Incrementing version to v6 to support Origin/Destination tracking for Auto-Sync
