...
class TrashScreen extends ConsumerWidget {
  ...
  Widget _buildTrashCard(BuildContext context, WidgetRef ref, InvoiceModel invoice) {
    return Card(
              ...
              onPressed: () async {
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Audit restored to Dashboard'),backgroundColor: Color(0xFFFFB300),),
                  );
                }
              },
            ),
  ...
  void _confirmHardDelete(BuildContext context, WidgetRef ref, InvoiceModel invoice) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Audit erased forever'),backgroundColor: Color(0xFFFFB300),),
                );
              }
            },
