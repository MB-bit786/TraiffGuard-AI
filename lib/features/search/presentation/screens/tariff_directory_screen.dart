        ...
        children: [
          ...
          Expanded(
            child: searchState.when(
              ...
              error: (err, __) => _buildErrorState(err.toString()),
            ),
          ),
        ],
      ),
  ...
  Widget _buildInitialState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.menu_book_rounded, size: 64, color: TariffColors.navyElevated.withValues(alpha: 0.5)),
          const SizedBox(height: 16),
          const Text(
            'Global Tariff Dictionary',
            style: TextStyle(color: TariffColors.textPrimary, fontWeight: FontWeight.bold, fontSize: 18),
          ),
          const SizedBox(height: 8),
          const Text(
            'Type a commodity name or HS code\nto explore the universal 6-digit library.',
